...
const WhatsAppFloat = () => (
  <div className="fixed bottom-10 right-4 z-50 sm:bottom-7 sm:right-6">
    <div className="absolute inset-2 rounded-full bg-[#25D366]/25 blur-2xl animate-pulse" aria-hidden="true" />
    ...
    <a
      ...
      className="group relative flex items-center gap-3 rounded-full border border-white/10 bg-[linear-gradient(135deg,rgba(10,16,25,0.92),rgba(19,45,36,0.94))] px-3 py-3 shadow-[0_18px_45px_rgba(0,0,0,0.35)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_24px_55px_rgba(37,211,102,0.24)] active:scale-[0.98]"
    >
      ...
      <span className="relative flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_0_0_6px_rgba(37,211,102,0.12)]">
        <span className="absolute inset-[-6px] rounded-full border border-[#25D366]/35 animate-pulse" aria-hidden="true" />
